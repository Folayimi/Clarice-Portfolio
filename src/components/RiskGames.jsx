              ...
              <div className="flexmm block sm:hidden w-full">
                <div className="w-[80%] h-full flexbm dsk-svg rounded-3xl">
                  <div className="relative w-[25%] cflexsm text-black">
                    ...
                    <Link href="https://fidgetbubbles.com" className="z-50 mt-[8em] underline italic -mr-5 relative">
                      fidgetbubbles.com
                    </Link>
                  </div>
                  ...
                  <div className="w-[18%] cflexmm gap-3 h-full mr-7">
                    ...
                    <Link href="https://www.apple.com/app-store/" className="bg-black p-3 rounded-xl w-full cursor-pointer">
                      <Image
                        src={"/apple.svg"}
                        alt="smt"
                        width={100}
                ...
                <div className="-z-0 flexmm w-full bg-svg rounded-3xl">
                  <div className="w-full h-full cflexsm text-black">
                    <div className="relative w-full cflexsm">
                      ...
                      <Link href="https://fidgetbubbles.com" className="mt-[50%] underline italic text-xl">
                        fidgetbubbles.com
                      </Link>
                    </div>
                    <div className="cflexss py-5 px-5 w-full gap-5">
                      ...
                      <div className="flex flex-col justify-center items-start gap-3 text-black text-sm w-full text-justify">
                        ...
                        <p>
                          ...
                          anxiety. Each bubble you pop releases a satisfying fidget
                          effect that's both calming and therapeutic.
                        </p>
                        <p>
                          Your goal is to pop as many bubbles as possible to earn
                          points. Some bubbles contain special items that give you
                          bonuses, adding excitement and increasing your chances of
                          a higher score.
                        </p>
                      </div>
