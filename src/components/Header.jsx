  ...
  return (
    <>
      <div className="fixed top-0 left-0 text-primary1 flexbs z-50 w-full py-4 pr-20 sm1:pr-4 pl-4 bg-black font-sans">
        <div
          style={{ right: `${margin}%` }}
          className="sm1:block fixed top-0 w-[55vw] pb-10 bg-white z-100 text-black border-2 border-black transition-all duration-1000 ease-in-out hidden"
        >
          ...
          <ul className="cflexss px-5 gap-7 list-none text-primary2 font-semibold text-sm">
            <li
            ...
            <li className="relative cursor-pointer cflexmm">
              ...
              <ul
                className={
                  show === "hidden"
                    ? "hidden"
                    : "block absolute top-[3em] w-[10em] h-[18em] rounded-sm flex flex-col justify-between items-center gap-[1em] bg-white p-2"
                }
              >
                <li
                  className="menu"
